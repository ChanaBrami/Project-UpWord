...
$(function() {    
    ...
    //if current user dont have local stogare points
    // we set points to 0
    if(localStorage.getItem('user_points_counter')==null || localStorage.getItem('user_level')==null){
        ...
        // set counter points from local storage to main counter and all levels                   
    ...
    $(document).on('click','.level_link',function(){        
       ...
       var voices = '';
        ...
        // set the user level- add one if 
        //flagg=plus/minus/askfor_new_level
            ...
            if($flag=='ask_for_new_level'){                
               ...
               var game_level_id = $(".game_level_id").data('lvl'); 
                ...
                if(localStorage.getItem('user_level')==undefined || localStorage.getItem('user_level')=='' || localStorage.getItem('user_level')==null ){
                    ...
                    $('.level_2').text(0);
                    $('.level_3').text(0);
                    Speak('To begin please press on the blue button');
                }else
...
//if user in level 3 - end game  otherwise user can go up a level
